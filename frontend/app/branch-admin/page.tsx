    ...
    return (
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem' }}>
                <div>
                    <h1 style={{ fontSize: '2rem', fontWeight: 900, marginBottom: '0.25rem' }}>Good Morning, Branch Admin 👋</h1>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                    ...
                    {true && (
                        <button type="button" onClick={() => router.push('/branch-admin/admissions')} style={{ backgroundColor: '#0066FF', color: 'white', border: 'none', padding: '0.5rem 1rem', borderRadius: '0.5rem', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem', boxShadow: '0 4px 14px 0 rgba(0,102,255,0.39)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
                ...
                <div style={{ backgroundColor: 'rgba(255,255,255,0.02)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '1.5rem', padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <div>
                        ...
                        <p style={{ fontSize: '2rem', fontWeight: 800 }}>845</p>
                    </div>
                </div>
                ...
                <div style={{ backgroundColor: 'rgba(255,255,255,0.02)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '1.5rem', padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <div>
                        <h3 style={{ color: '#9CA3AF', fontSize: '0.875rem', fontWeight: 600, marginBottom: '0.25rem' }}>Total Classes</h3>
                        <p style={{ fontSize: '2rem', fontWeight: 800 }}>34</p>
                    </div>
                </div>
            </div>
