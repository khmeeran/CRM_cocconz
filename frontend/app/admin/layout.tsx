...
import { 
  LayoutDashboard, Building2, Users, GraduationCap, UserPlus, 
  Wallet, IndianRupee, ReceiptText, AlertCircle, PieChart, 
  ShieldAlert, Settings, Bell, Search, Menu, X, LogOut, ChevronRight 
} from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navGroups = [
    {
      title: 'Main',
      items: [{ name: 'Dashboard', path: '/admin', icon: <LayoutDashboard size={18} /> }]
    },
    {
      title: 'Organization',
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Admissions', path: '/admin/admissions', icon: <UserPlus size={18} /> }
      ]
    },
    {
      title: 'Finance',
      items: [
        { name: 'Fee Structure', path: '/admin/fee-structure', icon: <Wallet size={18} /> },
        { name: 'Collections', path: '/admin/collections', icon: <IndianRupee size={18} /> },
        { name: 'Receipts', path: '/admin/receipts', icon: <ReceiptText size={18} /> },
        { name: 'Dues', path: '/admin/dues', icon: <AlertCircle size={18} /> }
      ]
    },
    {
      title: 'Administration',
      items: [
        { name: 'Users', path: '/admin/users', icon: <ShieldAlert size={18} /> },
